...
<?php echo $validation['id'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input  class="input-xlarge" type="text" pattern="^\d{9,18}$" title="eg:04471*******1" placeholder="Bank account number ******.." name='f_ac'/> 
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="f_phone"> Farmer Phone NO:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" pattern="[7-9]{1}[0-9]{9}" title="eg:98******34"  placeholder="+254******.." name='f_phone'/> 
        </div>
    </div>
    <div class="control-group">
